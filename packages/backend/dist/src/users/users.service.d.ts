...
export declare class UsersService {
    ...
    readonly LOCAL_PROFILE_PICTURE_DIRECTORY: string;
    private readonly PROFILE_PICTURE_BASE_URL;
    constructor(databaseService: DatabaseService, authService: AuthService, configService: ConfigService);
