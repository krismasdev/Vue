...
class CreateGroupChatDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { name: { required: true, type: () => String, minLength: common_1.STR_MIN_LENGTH, maxLength: common_1.STR_MAX_LENGTH }, userIds: { required: false, type: () => [String] } };
    }
}
__decorate([
...
], CreateGroupChatDto.prototype, "userIds", void 0);
